...
class FaqController extends Controller
{
    public function index()
    {
        $faqs = [
            ...
            ['question' => 'How do I request a game on EpicRepacks?', 'answer' => 'Go to the Request Games page on EpicRepacks and submit a request using the specified format. Note: It takes time to make repacks, please do not be repetitive, We will ignore such request and make sure to request only cracked titles'],
