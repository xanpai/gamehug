...
class FaqController extends Controller
{
    public function index()
    {
        $faqs = [
            ...
            ['question' => 'How does AnkerGames source its games?', 'answer' => 'AnkerGames sources its games from trusted forums like CS.RIN OFME and CSF files. All games are based on original ISO files released by scene groups, ensuring high quality and reliability.'],
            ...
            ['question' => 'Why does some games have Other Developer / Publisher, other than their original?', 'answer' => 'Other Developers is a dedicated category for highlighting the incredible work of smaller developers in the gaming community. With so many talented creators out there, it’s impossible for us to feature every individual developer on our platform. That’s why we’ve created this collection.'],
            ['question' => 'Can i use VPN to download files?', 'answer' => 'You can use a VPN to start downloads, however you can not switch back to your original network, the download will be interrupted and cancelled.'],
