                            ...
                            <tr>
                                <td>
                                    ...
                                    <a class="text-sm text-gray-600 dark:text-gray-200 flex items-center space-x-6 group"
                                        ...
                                        <div class="aspect-[2/3] rounded-md w-14 overflow-hidden relative">
                                        ...
                                        <div class="">
                                            ...
                                            <div class="text-xs text-gray-400 dark:text-gray-500">
                                                {{ Str::limit($listing->overview, 80) }}</div>
                                        </div>
                                    </a>
                                </td>
                                <td>
                                    <div class="flex items-center justify-end text-end space-x-5">
                                        @if ($listing->type == 'tv')
                                            <x-form.button-episode
                                                route="{{ route('admin.episode.index', ['post_id' => $listing->id]) }}"
                                                routeEpisode="{{ route('admin.episode.create', ['post_id' => $listing->id]) }}" />
                                        @endif
                                        <x-form.button-show route="{{ route($listing->type, $listing->slug) }}" />
                                        <x-form.button-edit
