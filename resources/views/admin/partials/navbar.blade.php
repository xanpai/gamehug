<header
    ...
    <nav class="flex basis-full items-center w-full mx-auto px-4 sm:px-6 md:px-8" aria-label="Global">
        <div class="lg:hidden">
            <button class="hamburger text-gray-500 dark:text-gray-300" :class="{ 'active': sidebarToggle }"
                @click.stop="sidebarToggle = !sidebarToggle" aria-controls="mobile-nav" :aria-expanded="sidebarToggle">
        ...
        <div class="shrink-0 ml-5 lg:ml-0 flex items-center">
            <a href="{{ route('admin.index') }}" class="text-gray-700 dark:text-gray-100 hover:text-gray-900">
                <h2 height="22" class="font-moontank"> AnkerGames
                </h2>
            </a>
            <span
        ...
        <div class="w-full flex items-center justify-end ml-auto sm:justify-between sm:gap-x-3 sm:order-3">
            ...
            <div class="flex grow justify-end flex-wrap items-center text-sm gap-x-2 text-gray-500 dark:text-gray-400">
                <a class="inline-flex flex-shrink-0 justify-center items-center h-10 w-10 font-medium rounded-full hover:bg-gray-100 dark:hover:bg-gray-800"
                    ...
                    <x-ui.icon name="delete" class="w-5 h-5" stroke="currentColor" stroke-width="1.75" />
                </a>
                ...
                <div class="relative inline-flex" x-data="{ open: false }">
                    ...
                    <div class="origin-top-right z-10 absolute inset-x-0 top-full mt-3 bg-white py-6 w-56 px-3 left-auto right-0 lg:-mr-1.5 lg:rounded-lg rounded-lg shadow-lg border border-gray-100 text-sm divide-y divide-gray-100 dark:bg-gray-900 dark:border-gray-900"
