    ...
    <div class="fixed bottom-4 left-0 right-0 z-40" x-show="!promote" x-cloak>
        <div
            ...
            <div class="flex items-center gap-x-6">
                ...
                <a href="{{ config('settings.promote_link') }}"
                    class="text-base hover:underline font-medium text-white tracking-tight">{{ config('settings.promote_text') }}</a>
                <div class="inline-flex cursor-pointer ml-auto rounded-full p-2 text-gray-500 hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-gray-600  dark:hover:bg-white/20 dark:hover:backdrop-blur-lg dark:text-white/70"
                    @click="promote = true">
        ...
        <div class="text-center">
            ...
            <div class="flex flex-col items-center mt-4">
                <div class="flex items-center justify-center space-x-4">
                    <!-- Language Dropdown -->
                    <div class="text-white inline-flex relative" x-data="{ open: false }">
                        ...
                        <div class="z-10 absolute inset-x-0 w-52 bottom-full mb-3 bg-white p-3 left-0 rounded-lg shadow-lg border border-gray-100 text-sm dark:bg-gray-800 dark:border-gray-800"
            ...
            <p class="text-gray-500 text-sm mt-4"> © {{ date('Y') }} {{ config('settings.site_name') }}. All
                rights reserved.</p>
        </div>
        <!-- End Grid -->
    </footer>
    ...
    <footer class="w-full lg:py-10 custom-container mt-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-12 gap-10 mb-10">
            <div class="col-span-full hidden lg:col-span-4 lg:block">
                <a class="flex-none text-xl text-gray-700 font-semibold dark:text-white" href="{{ route('index') }}"
                    aria-label="Brand">
...
@if (config('settings.cookie'))
    <div class="fixed bottom-4 right-4 z-[60] sm:max-w-lg" x-show="!cookiePolicy" x-cloak>
        <!-- Card -->
        <div class="p-7 bg-white rounded-2xl shadow-sm dark:bg-gray-800">
            <div class="flex gap-x-6">
                <svg class="h-10" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
 ...
 C334.667,313.082,356.751,335.166,356.751,362.314z" />
                ...
                <p class="text-sm text-gray-800 dark:text-gray-200">
                    {!! __('By browsing this website, you accept our :cookie.', [
                        'cookie' => mb_strtolower(
                            '<a href="' .
                                config('settings.cookie_url') .
                                '" target="_blank" class="inline-flex items-center gap-x-1.5 text-primary-500 decoration-2 hover:underline font-medium">' .
                                __('Cookies Policy') .
                                '</a>',
                        ),
                    ]) !!}
