@extends('layouts.app')
@section('content')
<title>Downloading {{ $listing->title }}</title>
...
<div class="relative overflow-hidden h-full">
    <div class="text-white max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-24 relative">
        <div class="absolute inset-0 z-0">
            ...
            <div class="absolute inset-0 before:absolute before:inset-0 before:bg-gradient-to-b before:from-gray-950 before:to-transparent before:z-10 after:absolute after:inset-0 after:bg-gradient-to-t after:from-gray-950 after:to-transparent after:via-gray-950/60 after:z-10"></div>
        </div>
        <div class="relative z-20 text-center">
            <h1 class="text-3xl tracking-tighter font-semibold line-clamp-1 hidden lg:block">Downloading: {{$listing->title}}</h1>
            <p class="mt-3 text-gray-300">Your loot will start downloading in <span id="countdown">5</span> seconds — brace yourself!</p>
            ...
            <div id="download-button" class="hidden mt-10">
                <a href="{{ $download->link }}" class="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded" target="_blank">
                    Download Now
                </a>
            </div>
