    ...
    <div x-data="{ selectedStream: '0', trailerOpen: false, iframeSrc: '', downloadOpen: false, repackFeaturesOpen: false }">
        <div class="container">
            ...
            <div id="search-modal"
                ...
                x-transition:enter="transition ease-in-out duration-200" x-transition:enter-start="opacity-0 trangray-y-4"
                x-transition:enter-end="opacity-100 trangray-y-0" x-transition:leave="transition ease-in-out duration-200"
