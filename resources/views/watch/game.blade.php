        ...
        <div class="lg:flex gap-6 xl:gap-12 relative">
            ...
            <div class="absolute inset-0 z-0">
                <div class="relative w-full h-full">
                    ...
                    <img src="{{$listing->coverurl}}" class="absolute h-full w-full object-cover" alt="{{$listing->title}} cover">
                </div>
            </div>
            ...
            <div class="relative z-10 w-full lg:flex gap-6 xl:gap-12">
                ...
                <div class="max-w-[16rem] w-full mx-auto hidden lg:block">
                    <div class="aspect-[2/3] relative rounded-md transition overflow-hidden cursor-pointer">
                        <img src="{{$listing->imageurl}}" class="absolute h-full w-full object-cover" alt="{{$listing->title}} poster">
                    </div>
                    @if($listing->trailer)
                    <x-form.secondary @click="trailerOpen = true;iframeSrc = '{{$listing->trailer}}'" class="w-full mt-4">{{__('Watch trailer')}}</x-form.secondary>
                    @endif
                </div>
                ...
                <div class="flex-1 text-white">
                    ...
                    @endif
                    <h1 class="text-3xl tracking-tighter font-semibold line-clamp-1 hidden lg:block">{{$listing->title}}</h1>
