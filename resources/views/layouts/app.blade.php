...
<body class="min-h-screen bg-gradient-to-r from-blue-50 to-blue-50 dark:bg-none dark:bg-gray-950 flex flex-col relative"
    ...
    @endif
    <div class="">
        <div class="flex-1 @if (!config('settings.layout') || config('settings.layout') == 'horizontal') {{ 'lg:ml-64 rtl:lg:ml-o rtl:lg:mr-64' }} @endif"
            :class="compactToggle ? 'lg:!ml-20 rtl:lg:!ml-0 rtl:lg:!mr-0' : ''">
            @yield('content')

        </div>
        <div class="@if (!config('settings.layout') || config('settings.layout') == 'horizontal') {{ 'lg:ml-64 rtl:lg:ml-o rtl:lg:mr-64' }} @endif mt-auto"
            :class="compactToggle ? 'lg:!ml-20 rtl:lg:!ml-0 rtl:lg:!mr-0' : ''">
